...
req.open("get", "https://api.weatherapi.com/v1/forecast.json?key=28ed099d534045a7967185812232102&q=cairo&days=3")
req.send();
...
function getData(test) {
    var req = new XMLHttpRequest();
    req.open("get", `https://api.weatherapi.com/v1/forecast.json?key=28ed099d534045a7967185812232102&q=${test}&days=3`)
    req.send();
    req.addEventListener("readystatechange", function () {
        if (req.readyState == 4) {
            all = JSON.parse(req.response);
